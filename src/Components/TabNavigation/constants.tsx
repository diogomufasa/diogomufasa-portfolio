...
export const styles = {
  ...
  vertical_navbar:
    'py-1 my-3 w-[60px] flex-center text-xl rounded-full shadow-xl border border-slate-50 dark:border-zinc-700',
  nav_button:
    'p-4 rounded-full hover:bg-slate-300 ease-in-out duration-500 cursor-pointer',
  tooltip: 'ml-4 rounded-r-xl',
  badge:
    'badge-circular shadow-xl block sm:hidden cursor-pointer fixed bottom-1 right-1 mb-[30px] mr-[20px] z-40',
